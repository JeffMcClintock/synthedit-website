...
The oscillator is typically the first module in a synthesizer signal chain. Connect a **MIDI-CV 2** module's pitch output to the oscillator's Pitch input for keyboard tracking.
