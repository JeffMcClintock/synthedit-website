...
<img src="../../images/guides/midi-automation/01-patch-automator.png" alt="MIDI flows through the Patch Automator inline: MIDI Player to Patch Automator's MIDI In, Patch Automator's MIDI Out to a MIDI-CV 2 module, then on to the oscillator and Sound Out" />
