...
For driving SynthEdit from Claude Code, Cursor, or any other [MCP-compatible](/guides/ai-mcp-connector/) AI assistant, install the headless command-line tool. It's standalone — works with or without the GUI.
...
3. Configure your AI host — see the [MCP connector guide](/guides/ai-mcp-connector/) for details
