...
<img src="../../images/guides/signal-types/01-cable-colors.png" alt="A patch showing all three cable colors: yellow MIDI from a MIDI Player2 into a MIDI-CV 2 module, blue audio from MIDI-CV 2's Pitch into the oscillator and from the oscillator into Sound Out, and a green list cable from a List Entry into the oscillator's Waveform input" />
